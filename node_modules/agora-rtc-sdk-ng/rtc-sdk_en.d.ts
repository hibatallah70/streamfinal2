...
export declare interface IAgoraRTCClient extends EventEmitter {
     ...
     * >   - Audio-only mode.
     * >   - Screen sharing.
     * > - Agora does not suggest enabling dual-stream mode on mobile devices.
...
export declare interface ILocalAudioTrack extends ILocalTrack {
     ...
     *
     * > Note:
     * > - As of v4.7.0, the SDK only supports setting the playback device for a remote track.
     ...
     *
     * @param processor The instance of the media processor.
     */
 ...
 */
declare enum InjectStreamEventStatus {
    /**
